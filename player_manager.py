...
class Player:
    ...
    # 武功境界加成表：武功境界 → 加成值（B方案：从0起，每晋一境+1）
    # 初学入门0·初窥门径1·略有小成2·略有所成3·渐入佳境4·融会贯通5
    # 登堂入室6·炉火纯青7·出神入化8·登峰造极9·超凡入圣10·返璞归真11·天人合一12·破碎虚空13
    ...
    # 品阶加成表：grade → bonus（B方案：从0起，每品+1；查表值覆盖json的bonus字段）
    GRADE_BONUS_TABLE = {
        9: 8, 8: 7, 7: 6, 6: 5, 5: 4,
        4: 3, 3: 2, 2: 1, 1: 0
    }
