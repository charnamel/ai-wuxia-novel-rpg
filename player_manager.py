...
class Player:
    ...
    # 每个境界对应的经验阈值（跨档差单调递增；8档=低天赋50年极限，9档=卡高天赋50年）
    EXP_THRESHOLDS = [0, 200, 500, 1100, 2000, 3300, 5200, 7500, 16000, 35000, 60000, 100000, 180000, 300000]
    ...
    SKILL_REALM_BONUS_TABLE = {
        ...
        "渐入佳境": 2, "融会贯通": 2, "登堂入室": 2, "炉火纯青": 3,
        "出神入化": 3, "登峰造极": 3, "超凡入圣": 4, "返璞归真": 4,
        "天人合一": 4, "破碎虚空": 5
    }
