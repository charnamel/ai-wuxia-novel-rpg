...
class Player:
    ...
    # 基础修正表：整体境界 → 修正值（表A）
    BASE_BONUS_TABLE = {
        "初学入门": 0, "初窥门径": 1, "略有小成": 2, "略有所成": 3,
        "渐入佳境": 4, "融会贯通": 5, "登堂入室": 6, "炉火纯青": 7,
        "出神入化": 8, "登峰造极": 9, "超凡入圣": 10, "返璞归真": 11,
        "天人合一": 12, "破碎虚空": 13
    }
    # 武功境界加成表：武功境界 → 加成值（0.5版：境界主导，每晋一境+0.5，浮点值）
    # 初学入门0·初窥门径0.5·略有小成1.5·略有所成2·渐入佳境2.5·融会贯通3
    # 登堂入室3.5·炉火纯青4·出神入化4.5·登峰造极5·超凡入圣5.5·返璞归真6·天人合一6.5·破碎虚空7
    SKILL_REALM_BONUS_TABLE = {
        "初学入门": 0, "初窥门径": 0.5, "略有小成": 1.5, "略有所成": 2,
        "渐入佳境": 2.5, "融会贯通": 3, "登堂入室": 3.5, "炉火纯青": 4,
        "出神入化": 4.5, "登峰造极": 5, "超凡入圣": 5.5, "返璞归真": 6,
        "天人合一": 6.5, "破碎虚空": 7
    }
    # 品阶加成表：grade → bonus（0.5版：档距0.5，区间1~5，低品阶不拖后腿；查表值覆盖json的bonus字段）
    GRADE_BONUS_TABLE = {
        9: 5.0, 8: 4.5, 7: 4.0, 6: 3.5, 5: 3.0,
